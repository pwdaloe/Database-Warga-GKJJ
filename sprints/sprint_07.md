...
> **Catatan penomoran**: sprint ini semula bernomor Sprint 6, digeser ke Sprint 7 karena Sprint 6
> disisipkan untuk test coverage `import.ts`/`warga.service.ts` (blocker HIGH recurring 5x dari
> retro, lihat `RETRO.md` entry 2026-07-08). Isi & lingkup sprint ini tidak berubah, hanya nomornya.
